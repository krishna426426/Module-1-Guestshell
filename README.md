...
**NOTE**: You will see multiple files in guest share. Ignore if you don’t have any of those files. These files are from previous lab which we will delete now and create new.
